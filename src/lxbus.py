...
APP_MAIL = "dontfoolme@lxbusinfo.appspotmail.com"
...
def parseCarrisMail(stopcode, mailbody):
    ...
    if invalidcodep is not None:
        hasResults = BUSREQUEST_RETURNED_INVALID
    elif notfoundb is not None and notfoundb.contents[0] == "N&atilde;o foram encontrados Resultados.":
